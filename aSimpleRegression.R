...
fit1 <- lm(y~x1)
fit1   #The coefficient is to compare with Z1b
fit2 <- lm(y~x1+x2)
fit2   #The coefficient is to compare with Z2b   
fit3 <- lm(y~x1+x2+x3)
fit3   #The coefficient is to compare with Z3b
fit4 <- lm(y~x1+x2+x3+x4)
fit4 #The coefficient is to compare with Z3b
